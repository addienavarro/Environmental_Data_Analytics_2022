...
NTL.phys.data.tuesday<-filter(NTL.phys.data, year4 %in% c(1990:1999) & lakename=="Tuesday Lake")
...
> Answer: Because row numbers are arbitrary and don't necessarily match with the data 
